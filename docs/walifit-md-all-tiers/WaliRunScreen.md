...
**Destination:** `apps/mobile/screens/WaliRunScreen.tsx`
...
import {
  Play, Square, Pause, MapPin, Battery, Wifi,
    ...
    <ScrollView contentContainerStyle={styles.summaryContent} showsVerticalScrollIndicator={false}>
      ...
      {s.isPR && (
        <View style={[styles.prBanner, { backgroundColor: colors.blue }]}>
          <Award color={'#0B0E14'} size={20} strokeWidth={2} />
...
const styles = StyleSheet.create({
  ...
  startBtnText:       { fontSize: typography.size.lg, fontWeight: typography.weight.bold, color: '#0B0E14' },
  ...
  activeContainer:    { flex: 1, backgroundColor: '#050A0A' },
  ...
  mapPlaceholder:     { height: 160, backgroundColor: '#0D1117', marginHorizontal: spacing.screen, borderRadius: radius.lg, overflow: 'hidden', position: 'relative', marginBottom: spacing.md },
  mapRoute:           { position: 'absolute', top: 40, left: 30, right: 60, height: 3, backgroundColor: colors.blue, borderRadius: 2 },
  mapDot:             { position: 'absolute', bottom: 40, right: 40, width: 12, height: 12, borderRadius: 6, backgroundColor: colors.blue, borderWidth: 2, borderColor: '#fff' },
  ...
  confirmOverlay:     { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', alignItems: 'center', justifyContent: 'flex-end' },
  ...
  confirmFinishBtnText:{ fontSize: typography.size.base, fontWeight: typography.weight.bold, color: '#fff' },
  ...
  prBannerText:       { fontSize: typography.size.base, fontWeight: typography.weight.extrabold, color: '#0B0E14' },
  ...
  summaryMapPlaceholder:{ height: 160, backgroundColor: '#0D1117', borderRadius: radius.lg, alignItems: 'center', justifyContent: 'center' },
  ...
  shareRunBtnText:    { fontSize: typography.size.base, fontWeight: typography.weight.bold, color: '#0B0E14' },
